...
CUDA_VISIBLE_DEVICES=0 python -u train.RTE.py \
    ...
    --max_seq_length 128 \
    --seed 16 > log.RTE.PretrainEpochs.10.seed.16.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=6 python -u train.RTE.py \
    ...
    --learning_rate $LEARNINGRATE \
    --max_seq_length 128 \
    --seed 32 > log.RTE.PretrainEpochs.10.seed.32.txt 2>&1 &

CUDA_VISIBLE_DEVICES=7 python -u train.RTE.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
    ...
    --learning_rate $LEARNINGRATE \
    --max_seq_length 128 \
    --seed 64 > log.RTE.PretrainEpochs.10.seed.64.txt 2>&1 &
