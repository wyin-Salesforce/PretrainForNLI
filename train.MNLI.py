...
class RteProcessor(DataProcessor):
    ...
    def generate_threeway_pretrain_examples(self, input_examples, pretrain_sample_size):
        examples=[]
            ...
            for sent in [sent_1, sent_2]:
                ...
                if sent_len >= 8:
                    for _ in range(pretrain_sample_size):
                        ...
                        examples.append(
                            InputExample(guid='pretrain', text_a=pos_left_sent, text_b=neg_right_sent, label='contradiction'))
                        examples.append(
                            InputExample(guid='pretrain', text_a=pos_left_sent, text_b=sent.strip(), label='neutral'))
        return examples
